      ...
      <main className="flex flex-col md:flex-row items-center max-md:text-center justify-between mt-1 pb-16 px-6 sm:px-10 md:px-24 max-w-7xl mx-auto w-full">
        ...
        <div className="flex flex-col items-center md:items-start">
          ...
          <div className="flex flex-col md:flex-row items-center mt-8 gap-3">
            <button className="bg-indigo-600 text-white px-6 pr-2.5 py-2.5 rounded-full text-sm font-medium flex items-center space-x-2 hover:bg-indigo-700 transition" type="button">
            ...
            <a className="text-indigo-600 bg-indigo-100 px-5 py-2 cursor-pointer rounded-full text-sm font-medium hover:bg-indigo-200 transition" href="#">
              Contact Me
            </a>
          </div>
        </div>
