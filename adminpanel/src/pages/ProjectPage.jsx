...
// import AddProjectModal from '../popupModels/AddProjectModel';
...
//   const [deleteModal, setDeleteModal] = useState({ isOpen: false, projectId: null }); // State for delete modal
...
//     try {
//       const res = await axios.get('http://localhost:4000/api/v1/projects', { withCredentials: true });
...
//     try {
//       await axios.delete(`http://localhost:4000/api/v1/projects/${deleteModal.projectId}`, { withCredentials: true });
...
//             </div>
//             <button onClick={handleOpenModal} className="w-full md:w-auto px-6 py-2 bg-blue-600 cursor-pointer text-white font-medium rounded-lg shadow-md hover:bg-blue-700 transition-colors flex items-center justify-center space-x-2">
//               <FaPlus />
//               <span>Add New Project</span>
//             </button>

//             <AddProjectModal isOpen={isModalOpen} onClose={handleCloseModal} setProjects={setProjects}></AddProjectModal>
//           </div>
//         </div>
...
//                   className={`px-4 py-2 rounded-lg capitalize text-sm font-medium transition-colors ${activeTab === tab
...
//                     <button className="p-2 rounded-lg hover:bg-gray-200 transition-colors hover:text-blue-500"><FaEdit /></button>
//                     <button className="p-2 rounded-lg hover:bg-gray-200 transition-colors hover:text-red-500" onClick={() => { handleOpenDeleteModal(project._id) }}><FaTrash /></button>
...
//                       <button className="p-2 rounded-lg hover:bg-gray-200 hover:text-blue-500"><FaEdit /></button>
//                       <button className="p-2 rounded-lg hover:bg-gray-200 hover:text-red-500"><FaTrash /></button>
//                       <button className="p-2 rounded-lg hover:bg-gray-200 hover:text-gray-700"><FaEllipsisV /></button>
//                     </div>


//                   </div>
//                   <p className="text-xs text-gray-500 mt-2">Last Updated: {project.date}</p>
//                 </div>
//               </div>
//             ))
//           ) : (
...
function ProjectPage() {
  ...
  const API_ENDPOINT = 'http://localhost:4000/api/v1/projects';
